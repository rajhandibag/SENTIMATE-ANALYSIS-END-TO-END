...
MLFLOW_TRACKING_URI = "https://dagshub.com/rajhandibag/SENTIMATE-ANALYSIS-END-TO-END.mlflow"
dagshub.init(repo_owner="rajhandibag", repo_name="SENTIMATE-ANALYSIS-END-TO-END", mlflow=True)
...
def train_and_log_model(X_train, X_test, y_train, y_test, vectorizer):
    """Trains Linear SVM model with GridSearch and logs results to MLflow."""
    ...
    with mlflow.start_run():
        ...
        for params, mean_score, std_score in zip(
            ...
            with mlflow.start_run(run_name=f"SVM with params: {params}", nested=True):
        ...
        mlflow.log_metric("best_accuracy_score", best_acc)
